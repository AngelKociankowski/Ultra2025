...
export const PERMISOS = {
  admin: ['ver', 'apertura', 'cancelacion', 'corregir', 'editar_contrato', 'editar_finanzas', 'editar_operativo', 'usuarios', 'catalogos', 'bitacora', 'precios', 'respaldos'],
  juridico: ['ver', 'editar_contrato', 'bitacora'],
  finanzas: ['ver', 'editar_finanzas', 'bitacora', 'precios'],
  operaciones: ['ver', 'apertura', 'cancelacion'],
  ventas: ['ver', 'apertura', 'cancelacion', 'precios'],
};
