...
export function registrarApertura(payload, usuario) {
  ...
  // La zona y el asesor se eligen de una lista; se comprueban aquí para que
  // llegar por la API no sea una forma de volver a la captura libre.
...
export function actualizarServicio(id, payload, usuario) {
  ...
  for (const campo of ['zona', 'asesor']) {
