...
export const TIPOS = {
  ...
  tipo_repse: {
    ...
    columna: 'tipo_repse',
    lo: 'lo',
    ayuda: 'Si el servicio tiene REPSE o no. Son las dos únicas respuestas: agregar una tercera aquí solo lograría que el mismo dato se capturara de dos maneras.',
    ejemplo: 'SÍ',
  },
  uniforme: {
    etiqueta: 'Uniformes',
