 ...
 * estaba equivocada de arriba abajo. Al revisar la hoja de aperturas de 2026
 * resultó que la empresa nombra otra cosa: el REPSE va por nivel (básico, plus,
 * plus +) y el uniforme es institucional o traje. Sembrar opciones que nadie
 * usa es peor que no sembrar ninguna: la lista se llena de ruido y la gente
 * acaba pidiendo que le agreguen la suya.
 */
export const REPSE_BASE = ['REPSE BÁSICO', 'REPSE PLUS', 'REPSE PLUS +', 'SIN REPSE'];

export const UNIFORMES_BASE = ['INSTITUCIONAL', 'TRAJE', 'INSTITUCIONAL Y TRAJE'];
