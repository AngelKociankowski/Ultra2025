  ...
  return (
    <form onSubmit={enviar} className="space-y-4">
          ...
          {[
            ...
            <button
              ...
              className={`text-sm px-3 py-1.5 rounded-lg ${
                tipo === t ? 'bg-red-600 text-ultra-blanco' : 'bg-slate-800 text-slate-400 hover:text-white'
              }`}
            >
              {etiqueta}
            </button>
      ...
      <button
        type="submit"
        disabled={enviando}
        className="bg-red-600 hover:bg-red-500 disabled:opacity-50 text-ultra-blanco rounded-lg px-5 py-2.5 font-medium"
      >
        {enviando
          ? 'Registrando…'
          : esReduccion
